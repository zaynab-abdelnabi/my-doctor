                ...
                <ImageBackground source={require('../assets/doc-bg.png')} style={styles.background}>
                    <View style={styles.container}>
                        <View style={styles.textContainer}>
                            ...
                            <Text style={styles.text}>التطبيق الاول للربط بين الأطباء والمرضى</Text>
                        </View>
                        {this.state.token ? (
                            <Button text='إذهب إلى قائمة الأطباء' onPress={() => this.props.navigation.navigate('Doctors')} />
                        ) : (
                            <React.Fragment>
                                <Button text='تسجيل دخول' onPress={() => this.props.navigation.navigate('SignIn')} />
